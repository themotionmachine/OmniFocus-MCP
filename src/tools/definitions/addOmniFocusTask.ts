...
export const schema = z.object({
  ...
  dueDate: z
    .string()
    .optional()
    .describe('The due date of the task in ISO format (YYYY-MM-DD or full ISO date)'),
  deferDate: z
    .string()
    .optional()
    .describe('The defer date of the task in ISO format (YYYY-MM-DD or full ISO date)'),
  ...
  projectName: z
    .string()
    .optional()
    .describe('The name of the project to add the task to (will add to inbox if not specified)'),
  // Hierarchy support
