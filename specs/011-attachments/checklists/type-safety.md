...
- [ ] CHK011 - Does the `add_attachment` input schema enforce a maximum string length of 69,905,068 characters via `z.string().max(69905068)` as required by NFR-001? [Completeness, Spec NFR-001, Contracts add-attachment.ts]
