...
```json
// skill-rules.json
"project-catalogue-developer": {
  // ❌ Typo: catalogue vs catalog
}
```
...
#### UserPromptSubmit Debug Command
...
Too broad - Triggers on: "user manual", "file system", "create directory"
...
Matches everything with "create" - Triggers on: "create file", "create folder", "create account"
...
Matches everything in form/ - Triggers on: test files, config files, everything
...
Matches in comments, strings, etc. - Triggers on: `// Don't use Prisma here`
...
Change from "block" to "suggest" - this makes it advisory instead of blocking.
...
Fewer alternatives = faster matching
