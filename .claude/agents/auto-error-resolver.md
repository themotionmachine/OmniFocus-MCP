...
description: Automatically fix TypeScript compilation errors. Use proactively when TypeScript errors are detected during builds or when the user mentions compilation failures. Specializes in fixing import errors, type mismatches, and missing property errors.
