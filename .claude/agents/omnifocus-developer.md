...
- Use `mcp__tavily-mcp__tavily-search` for community patterns and debugging
- Use `mcp__context7__resolve-library-id` + `mcp__context7__get-library-docs` for library APIs
